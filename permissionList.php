        ...
        <table border="1" cellpadding="10">
            ...
            <tbody>
                ...
                if($rows>0)
                {
                    ...
                    {
                        echo "<tr><td>".$record['permissionid']."</td><td>".$record['name']."</td><td>".$record['description']."</td><td>".$record['createdon']."</td><td>".$record['createdby']."</td><td><button type='submit' name='edit' value='".$record['permissionid']."'>Edit</button></td> <td><button type='submit' name='delete' value='".$record['permissionid']."'>DELETE</button></td></tr>";
                    }
                }
                ?>
